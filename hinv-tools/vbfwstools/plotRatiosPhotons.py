...
class TFValidator: 
 ...
 def returnRMS(self,b,includeStat=False, includeAll=False): 
  ...
  allpars  = self.workspace.function("%s_QCDV_Z%s_bin%d"%(self.cat,self.ZProc,b)).getParameters(ROOT.RooArgSet())
  allpars2 = self.workspace.function("%s_EWKV_Z%s_bin%d"%(self.cat,self.ZProc,b)).getParameters(ROOT.RooArgSet())
